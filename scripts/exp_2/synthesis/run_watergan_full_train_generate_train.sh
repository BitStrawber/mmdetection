...
#   GPU=2 EPOCH=26 BATCH_SIZE=80 WATERGAN_IO_WORKERS=16 \
...
RESULTS_DIR="${RESULTS_DIR:-${SYN_ROOT}/watergan/results/${DATA_NAME}_gpu2}"
...
THROTTLE_DIAG:   ${WATERGAN_THROTTLE_DIAGNOSTICS}
