...
IMAGENET100K_R50_INIT="$PRETRAIN_DIR/${PRETRAIN_PREFIX}_dino_resnet50_100e_teacher_backbone.pth"
IMAGENET100K_VITS_INIT="$PRETRAIN_DIR/${PRETRAIN_PREFIX}_dino_vits_100e_teacher_backbone.pth"
