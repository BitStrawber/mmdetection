...
IMAGENET1K_R50_INIT="$PRETRAIN_DIR/imagenet1k_dino_resnet50_100e_teacher_backbone.pth"
IMAGENET1K_VITS_INIT="$PRETRAIN_DIR/imagenet1k_dino_vits_100e_teacher_backbone.pth"
